  ...
  lettersSubmissions: [
    {
      ...
      issueSlug: "/issue-1",
      message:
        "The phone calls unsettled me more the longer I sat with the issue. At first they felt like a hook. Later they felt tragic. By the end I couldn't decide whether they were a cry for help, a haunting, or something worse, which made the whole thing linger in a way most mystery comics don't.",
      status: "approved",
      featured: true,
      editorReply:
        "That ambiguity was important to me. I wanted the calls to feel emotionally true before they felt mechanically explained.",
    ...
    },
    {
      ...
      issueSlug: "/one-shot",
      message:
        "What struck me most was the restraint. It never felt like the book was begging me to admire how moody it was. It just trusted the quiet moments.",
      status: "approved",
      featured: true,
      editorReply: "",
    ...
    },
    {
      ...
      issueSlug: "/issue-1",
      message:
        "Bone feels like someone whose reputation arrived in town before he did. That made every interaction more interesting, because half the scene is people reacting to the idea of him.",
      status: "approved",
      featured: false,
      editorReply: "",
    ...
    },
    {
      ...
      issueSlug: "/one-shot",
      message:
        "I liked that the story left room for me to connect dots instead of over-explaining itself. It made the ending feel heavier.",
      status: "approved",
      featured: false,
      editorReply: "",
    ...
    },
    {
      ...
      issueSlug: "/issue-1",
      message:
        "The atmosphere landed immediately, but what kept me reading was Celia. She feels grounded in a way that keeps the mystery from floating off into pure mood.",
      status: "approved",
      featured: false,
      editorReply: "",
